...
def orders(symbol):
    ...
    for o in ordens:
        ...
        click.echo(
            f"{tipo} {o.symbol} {o.volume_current} {o.price_open:.{DIGITOS}f} ticket {o.ticket}"
        )
        log.info(
            f"{tipo} | {o.symbol} | volume: {o.volume_current} | preço: {o.price_open:.{DIGITOS}f} | ticket: {o.ticket}"
        )
